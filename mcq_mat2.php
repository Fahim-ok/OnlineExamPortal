...
if($q1=='19'){
    ...
    echo "1. Incorrect Answer."." ". " The correct answer is 19"."<br>";
}
if($q2=='11'){
    echo "2. Correct Answer."."<br>";
	$_SESSION['quiz_results'] += 1;
}else{
    echo "2. Incorrect Answer."." "." The correct answer is 11"."<br>";
}
if($q3=='11'){
    echo "3. Correct Answer."."<br>";
	$_SESSION['quiz_results'] += 1;	
}else{
    echo "3. Incorrect Answer."." "." The correct answer is 11"."<br>";
}
...
$sql = "INSERT INTO reportcard (u_id, Subject, Score) VALUES ('{$_SESSION["u_id"]}', 'Mathematics', '{$_SESSION['quiz_results']}' ) ";
